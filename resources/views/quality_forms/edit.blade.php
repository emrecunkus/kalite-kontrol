...
<div class="container">
    ...
    <form id="form" action="{{ route('form.update', $form->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
   ...
   <!-- Submit Button -->
    ...
    <!-- Reddetme Butonu -->
    <button type="button" class="btn btn-danger mt-4" id="rejectBtn" @if($disabled) disabled @endif>Reddet</button>
</form>
</div>
